        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Appointments_Users_HandledBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    CompanyId = table.Column<int>(type: "int", nullable: false),
                    CompAdminId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Manages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Manages_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Manages_Users_CompAdminId",
                        column: x => x.CompAdminId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeReserved = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    TimeCancelled = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_HandledBy",
                table: "Appointments",
                column: "HandledBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Manages_CompAdminId",
                table: "Manages",
                column: "CompAdminId");

            migrationBuilder.CreateIndex(
                name: "IX_Manages_CompanyId",
                table: "Manages",
                column: "CompanyId");
